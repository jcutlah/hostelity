        ...
        tripController.getTripById(tripId, function(trip){
            hostels.forEach(hostel => {
                ...
                hostelController.addHostel(hostel, function(newHostel){
                    ...
                    waypointController.findClosestWaypointToHostel(tripId, hostel.location.coordinates, 2000000, function(waypoint){
...
router.route("/")
    ...
    .post(function (req, res) {
        ...
        const tripName = req.body.tripName || `${trip.start} to ${trip.end}${waypoints.length > 2 ? `, with ${waypoints.length -2} stops` : ''}`;
